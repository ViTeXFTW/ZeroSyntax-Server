...
damageType_value: (PLUS | DASH)? (None_value | All_value | 'EXPLOSION' | 'Explosion' | 'explosion' | 'WATER' | 'Water' | 'water' | 'KILL_GARRISONED' | 'Kill_Garrisoned' | 'kill_garrisoned' | STATUS | 'CRUSH' | 'Crush' | 'crush' | 'ARMOR_PIERCING' | 'Armor_piercing' | 'armor_piercing' | 'SMALL_ARMS' | 'Small_arms' | 'small_arms' | 'GATTLING' | 'Gattling' | 'gattling' | 'RADIATION' | 'Radiation' | 'radiation' | 'FLAME' | 'Flame' | 'flame' | 'LASER' | 'Laser' | 'laser' | 'SNIPER' | 'Sniper' | 'sniper' | 'POISON' | 'Poison' | 'poison' | 'HEALING' | 'Healing' | 'healing' | 'UNRESISTABLE' | 'Unresistable' | 'unresistable' | 'DEPLOY' | 'Deploy' | 'deploy' | 'SURRENDER' | 'Surrender' | 'surrender' | 'HACK' | 'Hack' | 'hack' | 'KILL_PILOT' | 'Kill_pilot' | 'kill_pilot' | 'PENALTY' | 'Penalty' | 'penalty' | 'FALLING' | 'Falling' | 'falling' | 'MELEE' | 'Melee' | 'melee' | 'DISARM' | 'Disarm' | 'disarm' | 'HAZARD_CLEANUP' | 'Hazard_cleanup' | 'hazard_cleanup' | 'INFANTRY_MISSILE' | 'Infantry_missile' | 'infantry_missile' | 'AURORA_BOMB' | 'Aurora_bomb' | 'aurora_bomb' | 'LAND_MINE' | 'Land_mine' | 'land_mine' | 'JET_MISSILES' | 'Jet_missiles' | 'jet_missiles' | 'STEALTHJET_MISSILES' | 'Stealthjet_missiles' | 'stealthjet_missiles' | 'MOLOTOV_COCKTAIL' | 'Molotov_cocktail' | 'molotov_cocktail' | 'COMANCHE_VULCAN' | 'Comanche_vulcan' | 'comanche_vulcan' | 'SUBDUAL_MISSILE' | 'Subdual_missile' | 'subdual_missile' | 'SUBDUAL_VEHICLE' | 'Subdual_vehicle' | 'subdual_vehicle' | 'SUBDUAL_BUILDING' | 'Subdual_building' | 'subdual_building' | 'PARTICLE_BEAM' | 'Particle_beam' | 'particle_beam' | 'MICROWAVE' | 'Microwave' | 'microwave' | 'TOPPLING' | 'Toppling' | 'toppling' | STATUS);
armorType_value: (None_value | 'NORMAL' | 'Normal' | 'normal' | 'DEFAULT' | 'Default' | 'default' | 'TOPPLING' | 'Toppling' | 'toppling' | STATUS | 'PARTICLE_BEAM' | 'Particle_beam' | 'particle_beam' | 'MICROWAVE' | 'Microwave' | 'microwave' | 'EXPLOSION' | 'Explosion' | 'explosion' | 'CRUSH' | 'Crush' | 'crush' | 'ARMOR_PIERCING' | 'Armor_piercing' | 'armor_piercing' | 'SMALL_ARMS' | 'Small_arms' | 'small_arms' | 'GATTLING' | 'Gattling' | 'gattling' | 'RADIATION' | 'Radiation' | 'radiation' | 'FLAME' | 'Flame' | 'flame' | 'LASER' | 'Laser' | 'laser' | 'SNIPER' | 'Sniper' | 'sniper' | 'POISON' | 'Poison' | 'poison' | 'HEALING' | 'Healing' | 'healing' | 'UNRESISTABLE' | 'Unresistable' | 'unresistable' | 'WATER' | 'Water' | 'water' | 'DEPLOY' | 'Deploy' | 'deploy' | 'SURRENDER' | 'Surrender' | 'surrender' | 'HACK' | 'Hack' | 'hack' | 'KILL_PILOT' | 'Kill_pilot' | 'kill_pilot' | 'PENALTY' | 'Penalty' | 'penalty' | 'FALLING' | 'Falling' | 'falling' | 'MELEE' | 'Melee' | 'melee' | 'DISARM' | 'Disarm' | 'disarm' | 'HAZARD_CLEANUP' | 'Hazard_cleanup' | 'hazard_cleanup' | 'INFANTRY_MISSILE' | 'Infantry_missile' | 'infantry_missile' | 'AURORA_BOMB' | 'Aurora_bomb' | 'aurora_bomb' | 'LAND_MINE' | 'Land_mine' | 'land_mine' | 'JET_MISSILES' | 'Jet_missiles' | 'jet_missiles' | 'STEALTHJET_MISSILES' | 'Stealthjet_missiles' | 'stealthjet_missiles' | 'MOLOTOV_COCKTAIL' | 'Molotov_cocktail' | 'molotov_cocktail' | 'COMANCHE_VULCAN' | 'Comanche_vulcan' | 'comanche_vulcan' | 'SUBDUAL_MISSILE' | 'Subdual_missile' | 'subdual_missile' | 'SUBDUAL_VEHICLE' | 'Subdual_vehicle' | 'subdual_vehicle' | 'SUBDUAL_BUILDING' | 'Subdual_building' | 'subdual_building');
